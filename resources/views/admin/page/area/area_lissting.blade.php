            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <a href="{{ route('areas.create') }}" class="text-center btn btn-primary btn-icon mt-lg-0 mt-md-0 mt-3" title="Thêm khu vực mới">
                            <i class="btn-inner">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                                </svg>
                            </i>
                            <span class="ms-2">Thêm khu vực</span>
                        </a>
                    </div>
                                ...
                                @foreach ($areas as $area)
                                    <tr>
                                        ...
                                        <td class="d-flex align-items-center">
                                            <a href="{{ route('areas.edit', $area->area_id) }}" class="btn btn-sm btn-icon btn-warning me-2 mr-2">
                                            ...
                                            <form action="{{ route('areas.destroy', $area->area_id) }}" method="POST" class="delete-form">
                                                @csrf
                                                @method('DELETE')
